  ...
  <div class="container1">
		...
		<div class="col-lg-16">
			<div class="jumbotron" style="padding-top: 20px;">
				<form action="store2" method="get">
					<h1 style="text-align: center;">동규네 빵 신청</h1>
					<br>
					<br>
					<h5  style="font-family: "Hanna">주문하실 상품을 선택해 주세요</h5>
					<div class="form-group">
					<input type="checkbox"  name="dosirak1" value="샌드+과일">샌드+과일 
				    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="checkbox"  name="dosirak2" value="샌드+음료">샌드+음료
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="dosirak3" value="샌드+과일(대)">샌드+과일(대)
             	    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             	    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="checkbox"  name="dosirak4" value="과일+닭">과일+닭가슴살
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="dosirak5" value="샌드+닭">샌드+닭가슴살
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="checkbox"  name="dosirak6" value="샌드+과일+쿠키">샌드+과일+쿠키
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</div>
					<br>
					...
					<br>
					<h5>요청사항 입력(음료 변경,과일 교체등을 상세히 입력해주세요)</h5>
					<div class="form-group">
